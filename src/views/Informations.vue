                        ...
                        <div class="divide-y divide-gray-200">
                            <div class="py-8 sm:min-w-[375px] text-base leading-5 space-y-7 text-gray-700 sm:text-lg sm:leading-7">
                                ...
                                <div class="relative">
                                    <div class="relative w-full min-w-[200px]">
                                        <textarea class="peer h-full min-h-[150px] w-full resize-none rounded-[7px] border 
                                                ...
                                                disabled:bg-blue-gray-50 focus:shadow-md" placeholder=" "></textarea>
                                        <label class="before:content[' '] after:content[' '] pointer-events-none absolute left-0 
                                ...
                                <div class="relative w-full">
                                    <button class="bg-green-500 text-white rounded-md w-full 
