                            ...
                            <div class="max-w-full mx-auto">
                                ...
                                <div class="divide-y divide-gray-200">
                                    <div class="py-8 sm:min-w-[375px] text-base leading-5 space-y-7 text-gray-700 sm:text-lg sm:leading-7">
                                        <div class="relative">
                                            ...
                                            <label 
                                                ...
                                                class="absolute left-0 -top-3.5 text-gray-600 text-sm 
                                                          ...
                                                          peer-focus:text-sm peer-focus:text-green-500 text-clip
                                                          peer-focus:after:border-green-500 peer-disabled:text-transparent">
                                                Email Address
                                            </label>
                                        </div>
                                        <div class="relative">
                                        ...
                                        <div class="relative">
                                            <button type="submit" class="bg-green-500 hover:bg-green-600 text-white font-medium 
